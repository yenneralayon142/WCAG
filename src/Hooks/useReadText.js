...
export function useReadText() {
    ...
    useEffect(() => {
        const screenRead = () => {
            ...
            let voices = [];
            const textElements = document.querySelectorAll('p, span, a, li, td, th, h1, h2, h3, h4, h5, h6, label, select, input, button, footer, header, .text--normal, .text--large, .text--extralarge, .text--subtitle, .text-title, .k-menu-link-text');

    ...
    return (
        <>
            <input
                ...
                id="open-menu"
                className="hidden"
                aria-label="Abrir menú de accesibilidad web"
            />
            ...
            <div
                className={`sidebar ${
                    ...
                    settings.sidebarSize == "medium"
                        ? ""
                        : settings.sidebarSize == "large"
                        ? "sidebar--large"
                        : "sidebar--small"
                } `}
            >
                ...
                <div className="sidebar__buttons">
                    ...
                    <label
                        ...
                        aria-label="Cerrar menú de accesibilidad web"
                    >
                        <Button
                            rounded="full"
                            fillMode="flat"
                    ...
                    <label
                        ...
                        aria-label="Cambiar de posición menú de accesibilidad"
                    ...
                    <label
                        aria-label="Reestablecer las configuraciones del menú de accesibilidad"
                        onClick={handleRestartSidebar}
                    >
                        <Button
                            rounded="full"
                            fillMode="flat"

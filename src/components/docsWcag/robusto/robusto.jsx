 ...
 * 
 * @function Robusto El nombre de la función es Robusto
        ...
        <>
            <section className="accessibility accessibility--level-a">
                ...
                <div className="accessibility__item" id="robusto-aria">
                    ...
                    <ul>
                        <li className="text--normal">Los elementos interactivos tengan descripciones claras utilizando <span className="text--bold">`aria-label`</span> o <span className="text--bold">`aria-labelledby`</span></li>
                        <li className="text--normal">El rol de cada elemento interactivo, como botones y cuadros de texto, sea claro</li>
                        <li className="text--normal">Las tecnologías de asistencia puedan identificar y notificar los cambios en los estados, propiedades y valores de los elementos</li>
                    </ul>
                    <SyntaxHighlighter language="html" style={codeTheme}>
                        {codeExample2}
                    </SyntaxHighlighter>
                ...
                <div className="accessibility__item" id="robusto-aria2">
                    ...
                    <ul>
                        <li className="text--normal">No uses atributos ARIA en elementos que ya tienen comportamiento semántico (por ejemplo, no añadas `role="button"` a un botón)</li>
                        <li className="text--normal">Los modales y diálogos usan `role="dialog"` y el foco es gestionado adecuadamente para usuarios de teclado</li>
                        <li className="text--normal">Los atributos ARIA, como `aria-hidden`, se usen para controlar la visibilidad de los elementos que deben ser ignorados por las tecnologías de asistencia</li>
                    </ul>
                    <SyntaxHighlighter language="html" style={codeTheme}>
                        {codeExample3}
                    </SyntaxHighlighter>
            ...
            <section className="accessibility accessibility--level-aa">
                ...
                <div className="accessibility__item" id="robusto-contrast">
                    ...
                    <ul>
                        <li className="text--normal">Usa herramientas como <a href="https://webaim.org/resources/contrastchecker/">Contrast Checker</a> para verificar el contraste de tus colores</li>
                        <li className="text--normal">Asegúrate de que las combinaciones de color no dependan solo de la percepción del color (ej., no uses solo color para resaltar información)</li>
                    </ul>
                    <SyntaxHighlighter language="html" style={codeTheme}>
                        {codeExample4}
                    </SyntaxHighlighter>
                ...
                <div className="accessibility__item" id="robusto-focus">
                    ...
                    <ul>
                        <li className="text--normal">Asegúrate de que los elementos interactivos (botones, enlaces, campos de formulario) tienen un indicador de enfoque visible al usar el teclado</li>
                        <li className="text--normal">El indicador de enfoque debe ser fácilmente distinguible, como un borde resaltado o un cambio de color</li>
                    </ul>
                    <SyntaxHighlighter language="html" style={codeTheme}>
                        {codeExample5}
                    </SyntaxHighlighter>
            ...
            <section className="accessibility accessibility--level-aaa">
                ...
                <div className="accessibility__item" id="robusto-contrast2">
                    ...
                    <ul>
                        <li className="text--normal">Este es un nivel más alto que garantiza mejor legibilidad en condiciones de baja visibilidad</li>
                    </ul>
                    <SyntaxHighlighter language="html" style={codeTheme}>
                        {codeExample6}
                    </SyntaxHighlighter>
                ...
                <div className="accessibility__item" id="robusto-links">
                    ...
                    <ul>
                        <li className="text--normal">Asegúrate de que los enlaces tengan un texto descriptivo que explique a dónde llevará el usuario</li>
                        <li className="text--normal">Evita enlaces con textos genéricos como "haz clic aquí" o "más información"</li>
                    </ul>
                    <SyntaxHighlighter language="html" style={codeTheme}>
                        {codeExample7}
                    </SyntaxHighlighter>

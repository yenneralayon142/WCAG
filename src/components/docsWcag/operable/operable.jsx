            ...
            <section className="nivela__section">
                ...
                <div>
                    ...
                    <p>
                        ...
                        contenido en movimiento, parpadeo o desplazamiento
                    </p>
                    <SyntaxHighlighter language="html" style={darcula}>
                        {pause}
                    </SyntaxHighlighter>
                ...
                <div>
                    ...
                    <p>
                        ...
                        preserve el significado y la operabilidad
                    </p>
                    <SyntaxHighlighter language="html" style={darcula}>
                        {focusOrder}
                    </SyntaxHighlighter>
            ...
            <section className="nivelb__section">
                ...
                <div>
                    ...
                    <p>
                        ...
                        dentro de un conjunto de páginas
                    </p>
                    <SyntaxHighlighter language="html" style={darcula}>
                        {locationPage}
                    </SyntaxHighlighter>
                ...
                <div>
                    ...
                    <p>
                        ...
                        operabilidad por teclado visible
                    </p>
                    <SyntaxHighlighter language="html" style={darcula}>
                        {appareanceFocus}
                    </SyntaxHighlighter>
